...
<div id="loading"><img src="<?php echo elixir('img/loading.gif');?>" /></div>
		...
		<div class="con">
                         <form action="<?php echo url('user/account/insert_other_card');?>" method="post">
			<div class="user-recharge b-color-f">
				...
				<section class="m-top1px margin-lr">
					<div class="text-all dis-box j-text-all">
						<label class="t-remark">入单编号</label>
						<div class="box-flex input-text">
                                                    <input class="j-input-text" type="text" placeholder="填写要入单会员的编号" name="user_name" onblur="find2()"><p id='find'><font color="red" id= 'find_name2'></font></p>
					</div>
					</div>
				</section>
				...
				<section class="m-top1px margin-lr">
					<div class="text-all dis-box j-text-all">
						...
						<div class="box-flex input-text">
                                                    <input class="j-input-text" type="text" placeholder="填写推荐编号的会员会获得销售奖" name="re_username" onblur="find()"><p id='find'><font color="red" id= 'find_name'></font></p>
					</div>
					</div>
				</section>
