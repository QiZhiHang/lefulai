    ...
    <section class="user-center j-f-tel margin-lr">
        <div class="text-all dis-box j-text-all bank_card">
            ...
            <div class="box-flex input-text">
                <span class="j-input-text inputcard n-input"><?php echo $nick_name; ?></span>
        ...
        <div class="text-all dis-box j-text-all bank_user_name">
            <label>身份证号</label>
            <div class="box-flex input-text">
                <span class="j-input-text inputcard n-input"><?php echo ($real_user['self_num']); ?></span>
                <i class="iconfont icon-guanbi1 close-common j-is-null"></i>
            </div>
        </div>
        <div class="text-all dis-box j-text-all bank_region">
            <label>银行</label>
            <div class="box-flex input-text">
                <span class="j-input-text inputcard n-input"><?php echo ($real_user['bank_name']); ?></span>
                <i class="iconfont icon-guanbi1 close-common j-is-null"></i>
            </div>
        </div>
        <div class="text-all dis-box j-text-all bank_name">
            <label>银行卡号</label>
            <div class="box-flex input-text">
                <span class="j-input-text inputcard n-input"><?php echo ($real_user['bank_card']); ?></span>
                <i class="iconfont icon-guanbi1 close-common j-is-null"></i>
            </div>
        </div>
        <div class="text-all dis-box j-text-all bank_name">
            <label>认证时间</label>
            <div class="box-flex input-text">
                <span class="j-input-text inputcard n-input"><?php echo ($real_user['validate_time']); ?></span>
                <i class="iconfont icon-guanbi1 close-common j-is-null"></i>
            </div>
        </div>
        <div class="text-all dis-box j-text-all bank_name">
            <label>审核状态</label>
            <div class="box-flex input-text">
                <span class="j-input-text inputcard n-input color-red"><?php if($real_user['review_status'] == 1) { ?>审核通过<?php } elseif ($real_user['review_status'] == 2) { ?>审核未通过<?php } else { ?>未审核<?php } ?></span>
                <i class="iconfont icon-guanbi1 close-common j-is-null"></i>
            </div>
        </div>
        <div class="text-all dis-box j-text-all bank_name">
            <label>绑定手机</label>
            <div class="box-flex input-text">
                <span class="j-input-text inputcard n-input"><?php echo ($real_user['bank_mobile']); ?></span>
                <i class="iconfont icon-guanbi1 close-common j-is-null"></i>
            </div>
        </div>
    
        <button type="button" value="sub" class="btn-submit br-5 min-btn" style="margin-bottom:1rem"><a href="<?php echo url('realname', array('step' => 'edit'));?>">修改信息</a></button>
    </section>
</div>
    <!--快捷导航-->
    <script>
