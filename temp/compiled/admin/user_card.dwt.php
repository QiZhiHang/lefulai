        ...
        <div class="content">
            ...
            <div class="flexilist">
            	<div class="common-head">
                    <div class="fl">
                        <a href="<?php echo $this->_var['action_link2']['href']; ?>"><div class="fbutton"><div class="csv" title="<?php echo $this->_var['action_link2']['text']; ?>"><span><i class="icon icon-download-alt"></i>导出会员列表</span></div></div></a>
                        <a href="<?php echo $this->_var['action_link']['href']; ?>"><div class="fbutton"><div class="add" title="<?php echo $this->_var['action_link']['text']; ?>"><span><i class="icon icon-plus"></i>添加会员</span></div></div></a>
                    </div>
                    	...
                    	<table cellpadding="0" cellspacing="0" border="0">
                        	<thead>
                            	<tr>
                                    ...
                                    <th width="10%"><div class="tDiv"><a href="javascript:void; ">用户编号</a><?php echo $this->_var['sort_user_name']; ?></div></th>
                                    <th width="10%"><div class="tDiv">昵称</div></th>
                                    <th width="8%"><div class="tDiv">办卡级别</div></th>
                                    <th width="8%"><div class="tDiv">预计收益</div></th>
                                    <th width="8%"><div class="tDiv">添加日期</div></th>
                                    <th width="8%"><div class="tDiv">累计收益</div></th>
                                    <th width="6%"><div class="tDiv">收益次数</div></th>
...
?>
                            	<tr>
                                    ...
                                    <td><div class="tDiv">
                                        <?php if ($this->_var['list']['status'] == 1): ?><font class="red">980会员卡</font><?php endif; ?>
                                        <?php if ($this->_var['list']['status'] == 2): ?><font class="red">4900会员卡</font><?php endif; ?>
                                        <?php if ($this->_var['list']['status'] == 3): ?><font class="red">9800会员卡</font><?php endif; ?>
                                        <?php if ($this->_var['list']['status'] == 4): ?><font class="red">14700会员卡</font><?php endif; ?>
                                        <?php if ($this->_var['list']['status'] == 5): ?><font class="red">19600会员卡</font><?php endif; ?>
                                        <?php if ($this->_var['list']['status'] == 6): ?><font class="red">980销售卡</font><?php endif; ?>
                                        <?php if ($this->_var['list']['status'] == 7): ?><font class="red">1280顾客卡</font><?php endif; ?>
                                        <?php if ($this->_var['list']['status'] == 8): ?><font class="red">6400顾客卡</font><?php endif; ?>
                                        <?php if ($this->_var['list']['status'] == 9): ?><font class="red">12800顾客卡</font><?php endif; ?>
                                        <?php if ($this->_var['list']['status'] == 10): ?><font class="red">19200顾客卡</font><?php endif; ?>
                                        <?php if ($this->_var['list']['status'] == 11): ?><font class="red">25600顾客卡</font><?php endif; ?>
                                        <?php if ($this->_var['list']['status'] == 12): ?><font class="red">1280销售卡</font><?php endif; ?>

                                    </div></td>
                                    <td>
                                        <div class="tDiv">
                                            <?php echo $this->_var['list']['need_return']; ?>
                                        </div>
                                    </td>
                                    <td><div class="tDiv"><?php echo $this->_var['list']['add_time']; ?></div></td>
                                    <td>
                                        <div class="tDiv">
                                            <?php echo $this->_var['list']['has_return']; ?>
                                        </div>
                                    </td>
                                    <td><div class="tDiv"><span class="red"><?php echo $this->_var['list']['continue_times']; ?></span></div></td>
                                    
                                    <td class="handle">
                                    	<div class="tDiv a2">
                                            <a href="javascript:confirm_redirect('<?php if ($this->_var['user']['user_money'] != 0): ?><?php echo $this->_var['lang']['still_accounts']; ?><?php endif; ?><?php echo $this->_var['lang']['remove_confirm']; ?>', 'users.php?act=remove&id=<?php echo $this->_var['list']['']; ?>')" title="<?php echo $this->_var['lang']['remove']; ?>" class="btn_trash"><i class="icon icon-trash"></i>冻结</a>
                                        </div>
                                    </td>
                                </tr>
                                <?php endforeach; else: ?>
                                    ...
                                    <dd>
                                        <div  class="select_w145 imitate_select">
                                            ...
                                            <ul>
                                               ...
                                               <?php $_from = $this->_var['user_ranks']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('k', 'user_ranks');if (count($_from)):
    foreach ($_from AS $this->_var['k'] => $this->_var['user_ranks']):
?>
                                               <li><a href="javascript:;" data-value="<?php echo $this->_var['k']; ?>"><?php echo $this->_var['user_ranks']; ?></a></li>
