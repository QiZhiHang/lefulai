...
?><?php echo $this->_var['attribute']['attr_name']; ?><?php if (! ($this->_foreach['attribute']['iteration'] == $this->_foreach['attribute']['total'])): ?>，<?php endif; ?><?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?></th>
            ...
            <th width="8%" <?php if ($this->_var['goods_attr_price'] == 0): ?>class="hide"<?php endif; ?>><em class="require-field pointer">*</em>本店价<i class="sc_icon sc_icon_edit pointer pro_shop"></i></th>
...
?><?php echo $this->_var['one']['attr_value']; ?><input type="hidden" name="attr[<?php echo $this->_var['one']['attr_id']; ?>][]" value="<?php echo $this->_var['one']['attr_value']; ?>" /><?php if (! ($this->_foreach['one']['iteration'] == $this->_foreach['one']['total'])): ?>，<?php endif; ?><?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?></td>		
                    ...
                    <td width="8%"><input type="text" name="product_warn_number[]" onBlur="listTable.editInput(this, 'edit_product_warn_number', <?php echo empty($this->_var['group']['product_id']) ? '0' : $this->_var['group']['product_id']; ?>, $('#goods_model').val(), 'goods_model');" class="text w50 tc" autocomplete="off" value="<?php echo empty($this->_var['group']['product_warn_number']) ? '1' : $this->_var['group']['product_warn_number']; ?>" /></td>
                    <td width="10%"><input type="text" name="product_sn[]" onBlur="listTable.editInput(this, 'edit_product_sn', <?php echo empty($this->_var['group']['product_id']) ? '0' : $this->_var['group']['product_id']; ?>, $('#goods_model').val(), 'goods_model');" class="text w90" autocomplete="off" value="<?php echo $this->_var['group']['product_sn']; ?>" /></td>
                    <td width="10%"><input type="text" name="product_bar_code[]" onBlur="listTable.editInput(this, 'edit_product_bar_code', <?php echo empty($this->_var['group']['product_id']) ? '0' : $this->_var['group']['product_id']; ?>, $('#goods_model').val(), 'goods_model');" class="text w90" autocomplete="off" value="<?php echo $this->_var['group']['bar_code']; ?>" /></td>
                    <td width="5%">
