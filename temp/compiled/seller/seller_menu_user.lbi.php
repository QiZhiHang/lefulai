	...
	<div class="sidebar" id="sidebar">
		<div class="column-menu">
			...
			<ul id="seller_center_left_menu" style="padding-top:10px;">
				<?php $_from = $this->_var['user_menu_pro']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'menu_0_73241900_1510815186');if (count($_from)):
    foreach ($_from AS $this->_var['menu_0_73241900_1510815186']):
?>
				<li id="quicklink_<?php echo $this->_var['menu_0_73241900_1510815186']['action']; ?>" data-action="<?php echo $this->_var['menu_0_73241900_1510815186']['action']; ?>" style="display: block;"><a href="<?php echo $this->_var['menu_0_73241900_1510815186']['url']; ?>"> <?php echo $this->_var['menu_0_73241900_1510815186']['label']; ?> </a></li>
			...
			<div class="sitemap-menu">
				...
				<div class="content" id="quicklink_list">
					<?php $_from = $this->_var['seller_menu']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'menu_0_73241900_1510815186');if (count($_from)):
    foreach ($_from AS $this->_var['menu_0_73241900_1510815186']):
?>
					<dl>
						<dt><?php echo $this->_var['menu_0_73241900_1510815186']['label']; ?></dt>
						<?php $_from = $this->_var['menu_0_73241900_1510815186']['children']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'child');if (count($_from)):
